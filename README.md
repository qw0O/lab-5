...
**Бинарное дерево поиска (BST)** — это иерархическая структура данных, обладающая следующим свойством (свойством BST):
...
Благодаря этому свойству, поиск элементов в сбалансированном дереве выполняется за логарифмическое время, что значительно быстрее линейного поиска в массивах.
...
| Операция | В среднем | В худшем случае (разбалансированное дерево) | Смысл операции |
| :--- | :---: | :---: | :--- |
...
if __name__ == "__main__":
    ...
    # Визуальная структура получившегося дерева:
    #         10
    #        /  \
    #       5    15
    #      / \   / \
